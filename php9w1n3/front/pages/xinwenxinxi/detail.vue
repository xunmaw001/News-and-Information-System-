	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
				...
				<view class="uni-padding-wrap uni-common-mt">
					<view>
						<video id="myVideo" :src="detail.xinwenshipin" controls></video>
					</view>
				</view>
			</view>
				...
				<view class="content" :style='{"color":"#333","fontSize":"28rpx"}'>
					<rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;" :nodes="detail.xinwenxiangqing"></rich-text>
				</view>
			</view>
		...
		methods: {
			...
			async init(){
				...
				this.detail = res.data;
																												// 轮播图片
				this.swiperList = this.detail.xinwentupian ? this.detail.xinwentupian.split(",") : [];
																								//修改富文本的图片样式
